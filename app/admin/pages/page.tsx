  ...
  return (
    <div className="max-w-5xl space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-6">
        <div>
          <h1 className="text-xl font-bold text-slate-900 tracking-tight">Pages &amp; Block Builder</h1>
          ...
          return (
            ...
            >
              <div className="flex items-start gap-4 min-w-0">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#818CF8] to-[#4F46E5] text-white flex items-center justify-center shrink-0">
                ...
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {isHome && (
                      <span className="px-2 py-0.5 rounded-full text-[11px] font-bold bg-[#4F46E5]/15 text-[#4F46E5] border border-[#4F46E5]/30">
                        Default Home
                      </span>
                    )}
                    <span
                  ...
                  <div className="flex items-center gap-2 mt-1 text-sm text-slate-500">
                    <span className="font-mono text-[#4F46E5]">{publicUrl}</span>
                    <span>·</span>
              ...
              <div className="flex items-center gap-2 shrink-0 self-end sm:self-center">
                ...
                <Link
                  ...
                  className="flex items-center gap-1.5 px-3.5 py-1.5 bg-[#4F46E5] hover:bg-[#4338CA] text-white font-semibold text-sm rounded-xl transition-all shadow-md shadow-slate-200/50"
                >
                ...
                {!isHome ? (
                  <button
                    ...
                    className="p-2 text-rose-700 hover:bg-rose-500/10 rounded-xl transition-colors"
                    title="Delete page"
                  >
                    <Trash2 className="w-4 h-4" />
                  </button>
                ) : (
                  <div className="p-2 text-slate-500" title="Home page cannot be deleted">
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="w-full max-w-md bg-white border border-slate-200 rounded-2xl p-6 shadow-2xl space-y-4">
            <h3 className="text-sm font-semibold text-slate-900">Create New Website Page</h3>
            <form onSubmit={handleCreatePage} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center">
                  <span className="px-3 py-2 text-sm bg-slate-50 border border-r-0 border-slate-200 rounded-l-xl text-slate-500 font-mono">
                    /
                  </span>
                  <input
                    type="text"
                    ...
                    className="w-full px-3.5 py-2 text-sm bg-slate-50 border border-slate-200 rounded-r-xl text-slate-900 font-mono focus:outline-none focus:border-[#4F46E5]"
                  />
                </div>
              </div>
              ...
              <div className="flex justify-end gap-2 pt-2">
                <button
                  ...
                  className="px-3 py-1.5 text-sm text-slate-600 bg-slate-50 rounded-xl"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={creating}
                  className="px-4 py-1.5 text-sm font-semibold bg-[#4F46E5] text-white rounded-xl disabled:opacity-50"
                >
